    ...
    <div class="container py-5">
        <div class="row justify-content-start">
            <div class="col-lg-8 text-center text-lg-start">
                <h1 class="display-1 text-uppercase text-dark mb-lg-4">Vet Pro Care</h1>
                ...
                <div class="d-flex align-items-center justify-content-center justify-content-lg-start pt-5">
                    ...
                    <h5 class="font-weight-normal text-white m-0 ms-4 d-none d-sm-block">Ver Vídeo</h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="pb-5">
                    <div class="product-item position-relative bg-light d-flex flex-column text-center">
                        ...
                        <div class="btn-action d-flex justify-content-center">
                            ...
                            <a class="btn btn-primary py-2 px-3" href="{{route('show-product',$product)}}"><i class="bi bi-eye"></i></a>
                        </div>
                    </div>
                </div>
            @endforeach
